...
例如，如果需要下载 MISA—MD v0.4.0 版本对应的依赖包，可以通过链接 https://osdn.net/dl/misa-md/misamd-v0.4.0-vendor-20210413-160703.217989.tar 从[OSDN](https://osdn.net/pkg/misa-md/dependencies) 上下载。 
