...
const siteConfig = {
  ...
  url: 'https://hpcer.pages.hpcer.dev/CrystalMD/MDoc', // Your website URL
  ...
  editUrl: 'https://git.hpcer.dev/HPCer/CrystalMD/MDoc/blob/master/docs/',

  // If you have users set above, you add it here:
  users,

  /* path to images for header/footer */
  headerIcon: 'img/md.svg',
  footerIcon: 'img/md.svg',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} HPCDE lab of USTB`,
